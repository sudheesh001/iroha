    ...
    namespace converters {
      ...
      class JsonQueryFactory {
       ...
       private:
        ...
        // Serializers:
        using Serializer = void (JsonQueryFactory::*)(Document &, std::shared_ptr<const Query>);
        std::unordered_map<std::type_index, Serializer> serializers_;
        // Serialization handlers
        void serializeGetAccount(Document &json_doc, std::shared_ptr<const Query> query);
        void serializeGetAccountAssets(Document &json_doc, std::shared_ptr<const Query> query);
        void serializeGetAccountTransactions(Document &json_doc, std::shared_ptr<const Query> query);
        void serializeGetAccountAssetTransactions(Document &json_doc, std::shared_ptr<const Query> query);
        void serializeGetSignatories(Document &json_doc, std::shared_ptr<const Query> query);
